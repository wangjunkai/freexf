...
angular.module('freexf')
  .controller('lottery_ctrl', function ($scope, $rootScope, $injector, $location, $state, $ionicPopup, $ionicLoading, $ionicScrollDelegate, AUTH, ENV) {
      ...
      function htmlInit() {
          ...
          //var tdW = (trWidth.substring(0, trWidth.length - 2));
          $('#lottery td').css({'height': tdW});
          //$('#lottery tr').css('height', tdW / 3)
      }
