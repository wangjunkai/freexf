$(function () {
    ...
    $('.system-content').each(function () {
        ...
        var pLevel = $(this).find('.system-level').find('p');
        pLevel.height(textHeight);
        pLevel.css('line-height', textHeight + 'px');
    })
    ...
    var teacherurl = '/entrace/Dispatch.aspx?EndClientType=PC&FunctionName=Student.%E6%95%99%E5%B8%88%E5%88%97%E8%A1%A8&JsonPara=%7B%22Second%22:%22%e5%a4%9a%e8%af%ad%e7%a7%8d%2f%e6%97%a5%e8%af%ad%22%7D&Version=1';
    $.ajax({
        type: 'POST',
        cache: 'false',
        url: teacherurl,
    ...
    function showTeacher(data) {
        ...
        var sigboxWidth = (teaConWidth - 25) / 3.3;
