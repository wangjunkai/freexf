  ...
  //配置api路径
    .constant('ENV', {
      ...
      '_api': {
        ...
        __Note:'GetNoteList',//笔记列表
        __GetQuestionAnswer:'GetQuestionAnswerList'//答疑列表
      }
    })
    //修改RestAngular配置
    ...
    //笔记列表
    .factory('CourseNoteRepository', function (ENV, freexfRestAngular, baseRestAngular) {
      function CourseNoteRepository(api) {
        baseRestAngular.call(this, freexfRestAngular, api ? api : ENV._api.__Note)
      }

      baseRestAngular.extend(CourseNoteRepository);
      return function (api) {
        return new CourseNoteRepository(api);
      }
    })
    //答疑列表
    .factory('CourseQuestionAnswerRepository', function (ENV, freexfRestAngular, baseRestAngular) {
      function CourseQuestionAnswerRepository(api) {
        baseRestAngular.call(this, freexfRestAngular, api ? api : ENV._api.__GetQuestionAnswer)
      }

      baseRestAngular.extend(CourseQuestionAnswerRepository);
      return function (api) {
        return new CourseQuestionAnswerRepository(api);
      }
    })
    //我的课程
